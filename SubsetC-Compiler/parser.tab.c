...
{
       0,    64,    64,    67,    68,    69,    70,    73,    78,    85,
      91,    97,   100,   106,   109,   114,   114,   122,   126,   122,
     135,   138,   135,   151,   157,   163,   169
};
#endif
...
{
  "$end", "error", "$undefined", "MAIN", "IF", "ELSE", "WHILE", "DEC",
  "ID", "INTEGER", "RELOP", "'('", "')'", "'{'", "'}'", "';'", "OR", "AND",
  "NOT", "'+'", "'-'", "'*'", "'/'", "'='", "$accept", "PROGRAM", "STMTS",
  "STMT", "EXPR", "BLOCK", "$@1", "$@2", "$@3", "$@4", "$@5", "BOOL", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,    40,    41,   123,   125,    59,   266,   267,   268,    43,
      45,    42,    47,    61
};
# endif
...
{
       1,    -1,    16,    46,   -17,    12,   -17,    13,     5,    17,
      20,    46,    21,    29,   -17,    25,   -17,    46,   -17,   -17,
     -17,    25,    21,    25,    -8,    10,    21,   -16,   -17,    -4,
     -17,    23,    25,    25,    25,   -17,    21,    21,    31,   -17,
     -16,    23,   -17,    33,    38,    39,   -17,   -17,    46,    46,
      42,    43,    44,    46,   -17,    54,    47,   -17,   -17,    49,
      46,    50,   -17
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     4,     0,     0,     7,     0,     2,     3,     6,    13,
      14,     0,     0,     0,     0,     0,     0,     8,     5,     0,
      25,    12,     0,     0,     0,    15,     0,     0,     0,    11,
      26,     9,    10,     0,     0,    24,    23,    21,     0,     0,
       0,     0,     0,     0,    16,     0,     0,    18,    22,     0,
       0,     0,    19
};
...
{
      18,    27,    32,    33,     1,    34,    28,    29,    39,    31,
      30,    33,     3,    34,    38,    33,     4,    34,    40,    41,
      42,    14,    35,    12,    45,    46,    36,    37,    15,    19,
      20,    16,    21,    19,    20,    17,    21,    51,    52,    22,
      26,    23,    56,    47,    34,    23,    48,    36,    37,    61,
       5,    49,     6,     7,     8,    53,    37,    54,    55,    57,
       0,    58,    60,     0,    62
};

static const yytype_int8 yycheck[] =
{
      11,    15,    10,    19,     3,    21,    17,    21,    12,    23,
      22,    19,    13,    21,    26,    19,     0,    21,    32,    33,
      34,     8,    12,    11,    36,    37,    16,    17,    23,     8,
       9,    14,    11,     8,     9,    15,    11,    48,    49,    18,
      11,    20,    53,    12,    21,    20,    13,    16,    17,    60,
       4,    13,     6,     7,     8,    13,    17,    14,    14,     5,
      -1,    14,    13,    -1,    14
};
...
{
       0,     3,    25,    13,     0,     4,     6,     7,     8,    26,
      27,    29,    11,    33,     8,    23,    14,    15,    26,     8,
       9,    11,    18,    20,    28,    35,    11,    28,    26,    28,
      35,    28,    10,    19,    21,    12,    16,    17,    35,    12,
      28,    28,    28,    30,    31,    35,    35,    12,    13,    13,
      34,    26,    26,    13,    14,    14,    26,     5,    14,    32,
      13,    26,    14
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      28,    28,    28,    28,    28,    30,    29,    31,    32,    29,
      33,    34,    29,    35,    35,    35,    35
};
...
#line 64 "parser.y" /* yacc.c:1646  */
    { fout << "halt" << endl; printf("Ended code generation!\n"); }
...
#line 78 "parser.y" /* yacc.c:1646  */
    {
		string tmp((yyvsp[-2].id));
		string place3((yyvsp[0].place)->place);
...
#line 85 "parser.y" /* yacc.c:1646  */
    {
		string s1((yyvsp[-2].place)->place), s2((yyvsp[0].place)->place);
		string tmp = new_temp();
		strcpy((yyval.place)->place, tmp.c_str());
		fout << tmp << " = " << s1 << " + " << s2 << endl;
	}
...
#line 97 "parser.y" /* yacc.c:1646  */
    {
		strcpy((yyval.place)->place, (yyvsp[-1].place)->place);
	}
...
#line 106 "parser.y" /* yacc.c:1646  */
    {
		strcpy((yyval.place)->place, (yyvsp[0].id));
	}
...
#line 114 "parser.y" /* yacc.c:1646  */
    { 
		s.push(new_label()); 
		string tmp((yyvsp[-1].place)->place);
...
#line 169 "parser.y" /* yacc.c:1646  */
    {
		string tmp((yyvsp[-1].relop));
		string false_label = new_label(), end_label = new_label();
		string tmp1((yyvsp[-2].place)->place), tmp2((yyvsp[0].place)->place);
